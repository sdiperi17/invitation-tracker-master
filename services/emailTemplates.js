...
[owa] .mj-column-per-25 { width:25% !important; max-width: 25%; }
    ...
    @media only screen and (max-width:480px) {
      ...
      <img alt="Baby Banner" height="auto" src="baby_shower_banner.png" style="max-width: 100%; border: 0; display: block; outline: none; text-decoration: none; height: auto; width: 100%;" width="600">
